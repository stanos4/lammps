...
PairStyle(repcubic,PairRepCubic)

#else

#ifndef LMP_PAIR_RepCubic_H
#define LMP_PAIR_RepCubic_H

#include "pair.h"

namespace LAMMPS_NS {

class PairRepCubic : public Pair {
 public:
  PairRepCubic(class LAMMPS *);
  virtual ~PairRepCubic();
